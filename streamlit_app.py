...
def clean_and_normalize(df):
    ...
    # Limpeza de tipos de dados numéricos (usando os campos _num que já existem nos seus dados)
...
if files:
    ...
    if all_dfs:
        # CONCAT SEGURO: Agora os DataFrames têm colunas únicas garantidas
        ...
        with tab1:
            ...
            for _, row in plot_df.iterrows():
                ...
                gmaps_url = f"https://www.google.com/maps/search/?api=1&query={addr_encoded}+North+Port+FL"
        ...
        with tab2:
            ...
            # Identificação de Imóveis Subavaliados (Arbitragem)
        ...
        with tab3:
            if st.button("🚀 GERAR RELATÓRIO DE ESTRATÉGIA"):
                with st.spinner('AI analisando cruzamento de dados...'):
                    ...
                    e potencial de ADU (Zoneamento). Cite tendências Zillow/Redfin/McKinsey 2025.
                    """
